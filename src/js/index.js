...
const bubbleUsedSkills = new CustomBubbleChart($('.summary-block')[0]);
const bubbleLearntSkills = new CustomBubbleChart($('.summary-block')[1]);
const bubbleCurrentTech = new CustomBubbleChart($('.summary-block')[2]);
const bubbleFutureTech = new CustomBubbleChart($('.summary-block')[3]);
const bubblePerceivedRisks = new CustomBubbleChart($('.summary-block')[4]);
const bubbleAttitudes = new CustomBubbleChart($('.summary-block')[5]);
const c3 = d3;
