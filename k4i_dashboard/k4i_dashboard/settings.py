"""
Django settings for k4i_dashboard project.
...
PROJ_DIR = ROOT_DIR.path("k4i_dashboard")
...
INSTALLED_APPS = [
    ...
    "k4i_dashboard.survey.apps.SurveyConfig",
...
ROOT_URLCONF = "k4i_dashboard.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": ["k4i_dashboard/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "k4i_dashboard.wsgi.application"
